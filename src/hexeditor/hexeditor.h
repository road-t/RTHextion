...
#ifdef HEXEDITOR_EXPORTS
#define HEXEDITOR_API Q_DECL_EXPORT
#elif HEXEDITOR_IMPORTS
#define HEXEDITOR_API Q_DECL_IMPORT
#else
#define HEXEDITOR_API
#endif
...
class HEXEDITOR_API HexEditor : public QAbstractScrollArea
{
    Q_OBJECT
