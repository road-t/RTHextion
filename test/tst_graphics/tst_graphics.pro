...
equals(capstone_enabled, true) {
    ...
    warning("Capstone not found for tst_graphics; disassembly-dependent code will be disabled")
}

INCLUDEPATH += ../../src ../../src/hexeditor ../../src/document ../../src/utils ../../src/audio ../../src/dockwidgets
