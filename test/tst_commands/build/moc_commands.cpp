...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_UndoStack_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_UndoStack_t qt_meta_stringdata_UndoStack = {
    {
QT_MOC_LITERAL(0, 9) // "UndoStack"
...
const QMetaObject UndoStack::staticMetaObject = { {
    ...
    qt_meta_stringdata_UndoStack.offsetsAndSize,
    qt_meta_data_UndoStack,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_UndoStack_t
, QtPrivate::TypeAndForceComplete<UndoStack, std::true_type>
